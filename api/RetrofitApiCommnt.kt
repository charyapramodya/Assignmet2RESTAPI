...
import com.example.assignment2.Model.Comment
...
interface RetrofitApiCommnt {

    abstract class RetrofitAPI {

        @GET("posts/{postID}/commnent")
        abstract fun getpostswithComments(@Path("postId") id: String): Call<List<Comment>>
